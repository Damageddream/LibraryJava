...
class EmailManager {
    public static void main(String[] args) {
        ...
        List<Email> sentEmails = filter(emailList, list -> list.isSent());
        System.out.println("Wysłane maile:");
        System.out.println(sentEmails);
        //filtrowanie maili, w których nadawca lub odbiorca ma wskazany adres email "bart@example.com"
        List<Email> bartEmails = filter(emailList, email -> email.getRecipient() == "bart@example.com" || email.getSender() == "bart@example.com");
