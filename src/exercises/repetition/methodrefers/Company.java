...
class Company {
    ...
    private static void printLongestInfor (String emp){
        System.out.println("Pracownik o najdłuższym imieniu i nazwisku to " + emp);
    }
    private static int compareLenght(String first, String secone){
        return Integer.compare(first.length(), secone.length());
    }
}